...
PicaFSConfig PicaFSConfig::BuildFromRegs(const Pica::Regs& regs, bool has_framebuffer_fetch,
                                         bool use_normal) {
    PicaFSConfig res{};
    ...
    if (regs.framebuffer.output_merger.alphablend_enable && has_framebuffer_fetch) {
