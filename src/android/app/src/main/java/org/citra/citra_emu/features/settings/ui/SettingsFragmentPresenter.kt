        ...
        sl.apply {
            val usernameSetting = object : AbstractStringSetting {
                override var string: String
                    get() = NativeLibrary.getUsername()
                    set(value) = NativeLibrary.setUsername(value)
            ...
            add(
                SingleChoiceSetting(
                    IntSetting.EMULATED_LANGUAGE,
                    R.string.emulated_language,
                    0,
                    R.array.languageNames,
                    R.array.languageValues,
                    IntSetting.EMULATED_LANGUAGE.key,
                    IntSetting.EMULATED_LANGUAGE.defaultValue
                )
            )
